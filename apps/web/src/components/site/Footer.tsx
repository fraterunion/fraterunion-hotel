            ...
            <div className="flex flex-col gap-2.5">
              {WHATSAPP_URL && (
                <a
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-5 py-2 text-[0.8rem] font-semibold text-white transition-colors duration-200 hover:bg-[#1ebe5d] sm:w-auto sm:justify-start"
                >
                  <WhatsAppIcon />
