          ...
          {!loading && !error && WHATSAPP_BOOKING_URL && (
            <div className="mt-20 flex flex-col items-center gap-4 border-t border-[var(--cabin-border-soft)] pt-16 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-8 py-3.5 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(37,211,102,0.25)] transition-all duration-200 ease-out hover:scale-[1.02] hover:bg-[#1ebe5d] hover:shadow-[0_12px_32px_rgba(37,211,102,0.38)]"
              >
