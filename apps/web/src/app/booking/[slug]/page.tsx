              ...
              {step === 'dates' && (
                <form onSubmit={handleCheckAvailability} className="space-y-5">
                  ...
                  <a
                    ...
                    className="inline-flex w-full min-h-[48px] items-center justify-center gap-2 rounded-full bg-[#25D366] px-6 text-sm font-semibold text-white shadow-[0_6px_20px_rgba(37,211,102,0.25)] transition-all duration-200 ease-out hover:bg-[#1ebe5d] hover:shadow-[0_10px_28px_rgba(37,211,102,0.38)]"
                  >
