          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            ...
            {process.env.NEXT_PUBLIC_WHATSAPP_BOOKING_URL && (
              <a
                ...
                className="inline-flex min-h-[52px] items-center gap-2.5 rounded-full border border-white/25 px-8 text-sm font-medium tracking-wide text-[var(--lv-cream)]/80 backdrop-blur-sm transition-all duration-200 hover:border-white/50 hover:text-[var(--lv-cream)]"
              >
