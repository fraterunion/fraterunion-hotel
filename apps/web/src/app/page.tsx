          ...
          <div className="mt-11 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
            ...
            {process.env.NEXT_PUBLIC_WHATSAPP_BOOKING_URL && (
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/12 bg-white/4 px-7 py-[14px] text-xs font-medium tracking-wide text-[var(--lv-cream)]/55 backdrop-blur-sm transition-all duration-200 ease-out hover:border-white/22 hover:text-[var(--lv-cream)]/75 sm:w-auto"
              >
                <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="shrink-0 opacity-65">
